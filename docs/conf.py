...
# -*- coding: utf-8 -*-
#
# cartoframes documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'cartoframes.tex', 'cartoframes Documentation',
     'CARTO', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'cartoframes', 'cartoframes Documentation',
     author, 'cartoframes', 'data science package for using CARTO',
     'Miscellaneous'),
]
