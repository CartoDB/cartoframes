...
class TestMapLayer(unittest.TestCase):
    def test_one_layer(self):
        ...
        self.assertIsNotNone(map.sources[0].get('interactivity'))
    ...
    def test_two_layers(self):
        ...
        source_1 = vis.source.GeoJSON(build_geojson([-10, 0], [-10, 0]))
        source_2 = vis.source.GeoJSON(build_geojson([0, 10], [10, 0]))
