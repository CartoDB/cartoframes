...
.. |beta| image:: https://mybinder.org/badge_logo.svg
    :target: https://mybinder.org/v2/gh/cartodb/cartoframes/v1.0b4?filepath=examples
...
To install the 1.0b4 version, run instead:

.. code:: bash

    (venv) $ pip install cartoframes==1.0b4 jupyter
...
.. code:: bash
    ...
    $ pipenv --three
    $ pipenv install cartoframes==1.0b4 jupyter
    $ pipenv run jupyter notebook
...
or to install the 1.0b4 version:
