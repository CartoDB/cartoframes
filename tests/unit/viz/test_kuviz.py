...
class TestKuvizPublisher(unittest.TestCase):
    ...
    def test_kuviz_publisher_create_local(self):
        ...
        self.assertNotEqual(kuviz_pub._layers, vmap.layers)
        self.assertEqual(len(kuviz_pub._layers), len(vmap.layers))
    ...
    def test_kuviz_publisher_has_layers_copy(self):
        ...
        kuviz_pub._layers = []
        self.assertNotEqual(len(kuviz_pub._layers), len(vmap.layers))
    ...
    def test_kuviz_publisher_from_local_sync(self):
        ...
        kuviz_pub = KuvizPublisherMock(vmap.layers)
        self.assertEqual(kuviz_pub.is_sync(), False)
    ...
    def test_kuviz_publisher_create_remote_sync(self):
        ...
        kuviz_pub = KuvizPublisherMock(vmap.layers)
        self.assertEqual(kuviz_pub.is_sync(), True)
