...
class TestLegend(object):
    ...
    def test_wrong_type(self):
        ...
        msg = 'Legend type is not valid. Valid legend types are: default, color-bins, ' + \
            ...
            'color-continuous-polygon, size-bins, size-bins-line, size-bins-point, ' + \
            'size-category, size-category-line, size-category-point, size-continuous, ' + \
            'size-continuous-line, size-continuous-point.'
        with pytest.raises(ValueError) as e:
