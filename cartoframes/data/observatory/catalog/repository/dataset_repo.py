from .constants import CATEGORY_FILTER, COUNTRY_FILTER, PROVIDER_FILTER, GEOGRAPHY_FILTER
...
_ALLOWED_FILTERS = [CATEGORY_FILTER, COUNTRY_FILTER, PROVIDER_FILTER, GEOGRAPHY_FILTER]
