...
class Dataset(object):
    ...
    def __init__(self, table_name=None, schema=None,
        ...
        self._c = context or _default_context
    ...
    def upload(self, with_lnglat=None, if_exists=FAIL, table_name=None, schema=None, context=None):
        ...
        if self._table_name is None or self._c is None:
    ...
    def download(self, limit=None, decode_geom=False, retry_times=DEFAULT_RETRY_TIMES):
        ...
        """
        if self._c is None or (self._table_name is None and self._query is None):
        ...
        self._df = self._c.fetch(query, decode_geom=decode_geom)
        return self._df
    ...
    def delete(self):
        ...
        """
        if self.exists():
            self._c.sql_client.send(self._drop_table_query(False))
            self._unsync()
            return True
    ...
    def get_table_columns(self):
        ...
        if self._query is not None:
            ...
            return get_columns(self._c, query)
        else:
            query = '''
            ...
            try:
                table_info = self._c.sql_client.send(query)
    ...
    def _get_remote_geom_type(self, query):
        ...
        if self._c:
            response = self._c.sql_client.send('''
    ...
    def _get_dataset_info(self):
        return DatasetInfo(self._c, self._table_name)
    ...
    def _get_schema(self):
        if self._c:
            return self._c.get_default_schema()
        else:
            return None
